...
import { abrirCaja, cerrarCaja, estadoCaja, obtenerArqueo, getCajas, registrarMovimiento } from '../controllers/caja.controller.js';
...
export async function cajaRoutes(fastify: FastifyInstance) {
  ...
  fastify.post('/caja/:caja_id/movimiento', registrarMovimiento);
}
